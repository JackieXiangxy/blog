	...
	<div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
	          ...
	          <div class="row">
	          	<div class="col-lg-6">
	          	<form action="<%=basePath%>admin/updateSysCategory?scgId=${sc.id}" method="post">
	          	 		<label>分类名：</label><input name="scgName" value="${sc.categoryName}" class="form-control" type="text"/><br>
